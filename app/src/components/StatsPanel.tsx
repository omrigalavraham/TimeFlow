        ...
        <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-slate-100 dark:border-slate-800 p-6 space-y-6 transition-colors">
            ...
            <div className="relative pt-1">
                ...
                <div className={`overflow-hidden h-2 mb-4 text-xs flex rounded ${colors.track}`}>
                    <div style={{ width: `${progress}%` }} className={`shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center transition-all duration-1000 ${colors.bar}`}></div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
                <div className="bg-slate-50 dark:bg-slate-800 p-3 rounded-lg text-center">
                    ...
                    <div className="text-2xl font-bold text-slate-700 dark:text-slate-200">{completed}/{total}</div>
                    <div className="text-xs text-slate-500 dark:text-slate-400">הושלמו</div>
                </div>
                <div className="bg-slate-50 dark:bg-slate-800 p-3 rounded-lg text-center">
                    <Target className="mx-auto text-blue-500 mb-1" size={20} />
                    <div className="text-xl font-bold text-slate-700 dark:text-slate-200" dir="ltr">{hoursLeft}h {minutesLeft}m</div>
